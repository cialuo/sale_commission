    ...
    def _get_amount(self):
        ...
        if (not self.sale_line.product_id.commission_free and
            ...
            if self.commission.commission_type == 'fixed':
                self.amount = self.commission.fix_amount
            elif self.commission.commission_type == 'percent':
                self.amount = subtotal * (self.commission.fix_percentage / 100.0)
            else:
